<template>
  <v-main class="ma-md-8">
    <v-container v-if="individual" class="ml-auto mr-auto">
      <v-row>
        <v-col
        ...
        >
          ...
          <v-row class="section mb-4">
            <v-container fluid class="pa-7 pt-6">
              <v-list-subheader class="mb-3">Profile</v-list-subheader>
              <v-row>
          ...
          <v-row class="section mb-4">
            <v-container fluid class="pl-7 pr-7 pt-6 pb-6">
              <identities-list
