...
describe("Logger plugin", () => {
  ...
  test("Logs error message", () => {
    wrapper.vm.$logger.error("Test error message");
  ...
  test("Logs debug message", () => {
    wrapper.vm.$logger.debug("Test debug message");
  ...
  test("Logs default message", () => {
    wrapper.vm.$logger.log("Test default message");
  ...
  test("Logs info message", () => {
    wrapper.vm.$logger.info("Test info message");
  ...
  test("Logs warning message", () => {
    wrapper.vm.$logger.warn("Test warning message");
